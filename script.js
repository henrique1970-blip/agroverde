...
function renderForm(activityKey) {
    ...
    formFields.forEach(field => {
        const isRequired = field.name !== 'observacao' && !field.name.includes('Container') && !field.name.includes('Products');
