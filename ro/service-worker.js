...
const appsScriptUrl = 'https://script.google.com/macros/s/AKfycbznEdqNDvPH34VOE6EQ510BUkk3s5NtZyN8KRMKaCns--qerlsupNlUaQdil1tPdK5R/exec'; // <-- COLOQUE SEU URL AQUI!
...
self.addEventListener('sync', event => {
    // Altere a tag aqui
    if (event.tag === 'sync-report-data') { // Verifica a tag específica para relatórios
        ...
        event.waitUntil(self.clients.matchAll().then(clients => {
            ...
            clients.forEach(client => {
                console.log('Service Worker: Enviando mensagem para o cliente iniciar a sincronização de relatórios.');
